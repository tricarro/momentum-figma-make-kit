...
<resources>
  ...
  <color name="mds-color-theme-text-error-hover">#1aebff</color>
  <color name="mds-color-theme-text-error-active">#1aebff</color>
  <color name="mds-color-theme-text-success-normal">#ffffff</color>
  <color name="mds-color-theme-text-success-hover">#1aebff</color>
  <color name="mds-color-theme-text-success-active">#1aebff</color>
  <color name="mds-color-theme-text-warning-normal">#ffffff</color>
  <color name="mds-color-theme-text-warning-hover">#1aebff</color>
  <color name="mds-color-theme-text-warning-active">#1aebff</color>
  <color name="mds-color-theme-text-highlight">#ffff00</color>
  <color name="mds-color-theme-text-accent-normal">#ffffff</color>
  <color name="mds-color-theme-text-accent-hover">#1aebff</color>
  <color name="mds-color-theme-text-accent-active">#1aebff</color>
  <color name="mds-color-theme-text-teamdefault-normal">#ffffff</color>
  <color name="mds-color-theme-text-teamdefault-hover">#1aebff</color>
  <color name="mds-color-theme-text-teamdefault-active">#1aebff</color>
  <color name="mds-color-theme-text-alert-purple-normal">#ffffff</color>
  <color name="mds-color-theme-text-alert-purple-hover">#1aebff</color>
  <color name="mds-color-theme-text-alert-purple-active">#1aebff</color>
  <color name="mds-color-theme-text-alert-orange-normal">#ffffff</color>
  <color name="mds-color-theme-text-alert-orange-hover">#1aebff</color>
  <color name="mds-color-theme-text-alert-orange-active">#1aebff</color>
  <color name="mds-color-theme-text-team-cobalt-normal">#ffffff</color>
  <color name="mds-color-theme-text-team-cobalt-hover">#1aebff</color>
  <color name="mds-color-theme-text-team-cobalt-active">#1aebff</color>
  <color name="mds-color-theme-text-team-cyan-normal">#ffffff</color>
  <color name="mds-color-theme-text-team-cyan-hover">#1aebff</color>
  <color name="mds-color-theme-text-team-cyan-active">#1aebff</color>
  <color name="mds-color-theme-text-team-mint-normal">#ffffff</color>
  <color name="mds-color-theme-text-team-mint-hover">#1aebff</color>
  <color name="mds-color-theme-text-team-mint-active">#1aebff</color>
  <color name="mds-color-theme-text-team-lime-normal">#ffffff</color>
  <color name="mds-color-theme-text-team-lime-hover">#1aebff</color>
  <color name="mds-color-theme-text-team-lime-active">#1aebff</color>
  <color name="mds-color-theme-text-team-gold-normal">#ffffff</color>
  <color name="mds-color-theme-text-team-gold-hover">#1aebff</color>
  <color name="mds-color-theme-text-team-gold-active">#1aebff</color>
  <color name="mds-color-theme-text-team-orange-normal">#ffffff</color>
  <color name="mds-color-theme-text-team-orange-hover">#1aebff</color>
  <color name="mds-color-theme-text-team-orange-active">#1aebff</color>
  <color name="mds-color-theme-text-team-pink-normal">#ffffff</color>
  <color name="mds-color-theme-text-team-pink-hover">#1aebff</color>
  <color name="mds-color-theme-text-team-pink-active">#1aebff</color>
  <color name="mds-color-theme-text-team-purple-normal">#ffffff</color>
  <color name="mds-color-theme-text-team-purple-hover">#1aebff</color>
  <color name="mds-color-theme-text-team-purple-active">#1aebff</color>
  <color name="mds-color-theme-text-team-violet-normal">#ffffff</color>
  <color name="mds-color-theme-text-team-violet-hover">#1aebff</color>
  <color name="mds-color-theme-text-team-violet-active">#1aebff</color>
  <color name="mds-color-theme-text-team-slate-normal">#ffffff</color>
  <color name="mds-color-theme-text-team-slate-hover">#1aebff</color>
  <color name="mds-color-theme-text-team-slate-active">#1aebff</color>
  <color name="mds-color-theme-inverted-text-primary-normal">#000000</color>
  <color name="mds-color-theme-inverted-text-primary-disabled">#3ff23f</color>
  <color name="mds-color-theme-inverted-text-secondary-normal">#000000</color>
  <color name="mds-color-theme-inverted-text-accent-normal">#000000</color>
  <color name="mds-color-theme-inverted-text-accent-hover">#1aebff</color>
  <color name="mds-color-theme-inverted-text-accent-active">#1aebff</color>
  ...
  <color name="mds-color-theme-background-solid-secondary-normal">#000000</color>
  <color name="mds-color-theme-background-solid-tertiary-normal">#000000</color>
  <color name="mds-color-theme-background-solid-quaternary-normal">#000000</color>
  <color name="mds-color-theme-background-secondary-normal">#000000</color>
  ...
  <color name="mds-color-theme-background-label-default-normal">#000000</color>
  <color name="mds-color-theme-background-label-default-hover">#1aebff</color>
  <color name="mds-color-theme-background-label-default-active">#1aebff</color>
  <color name="mds-color-theme-background-label-error-normal">#000000</color>
  <color name="mds-color-theme-background-label-error-hover">#1aebff</color>
  <color name="mds-color-theme-background-label-error-active">#1aebff</color>
  <color name="mds-color-theme-background-namelabel-normal">#000000</color>
  <color name="mds-color-theme-background-reaction-normal">#000000</color>
  ...
  <color name="mds-color-theme-background-glass-active">#000000</color>
  ...
  <color name="mds-color-theme-background-glass-radial-1">#000000</color>
  <color name="mds-color-theme-background-input-disabled">#3ff23f</color>
  <color name="mds-color-theme-background-overlay-normal">#ababab</color>
  ...
  <color name="mds-color-theme-button-cancel-normal">#000000</color>
  <color name="mds-color-theme-button-cancel-hover">#1aebff</color>
  <color name="mds-color-theme-button-cancel-pressed">#1aebff</color>
  ...
  <color name="mds-color-theme-outline-label-mint">#ffffff</color>
  <color name="mds-color-theme-outline-label-orange">#ffffff</color>
  <color name="mds-color-theme-outline-label-pink">#ffffff</color>
  ...
  <color name="mds-color-theme-outline-warning-normal">#ffffff</color>
  <color name="mds-color-theme-outline-glass-normal">#ffffff</color>
  <color name="mds-color-theme-outline-ai-normal">#ffffff</color>
  ...
  <color name="mds-color-theme-scrollbar-arrow-normal">#000000</color>
  <color name="mds-color-theme-scrollbar-arrow-background-normal">#ffffff</color>
  <color name="mds-color-theme-scrollbar-arrow-background-hover">#ffffff</color>
  <color name="mds-color-theme-scrollbar-arrow-background-pressed">#ffffff</color>
  <color name="mds-color-theme-scrollbar-background-secondary-ghost">#000000</color>
  <color name="mds-color-theme-scrollbar-background-secondary-normal">#000000</color>
  ...
  <color name="mds-color-theme-gradientdivider-default-normal">#ffffff</color>
  <color name="mds-color-theme-gradientdivider-default-hover">#ffffff</color>
  <color name="mds-color-theme-gradientdivider-error-normal">#ffffff</color>
  <color name="mds-color-theme-gradientdivider-error-hover">#ffffff</color>
  <color name="mds-color-theme-gradientdivider-warning-normal">#ffffff</color>
  <color name="mds-color-theme-gradientdivider-warning-hover">#ffffff</color>
  <color name="mds-color-theme-gradientdivider-announce-normal">#ffffff</color>
  <color name="mds-color-theme-gradientdivider-announce-hover">#ffffff</color>
  <color name="mds-color-theme-gradientdivider-success-normal">#ffffff</color>
  <color name="mds-color-theme-gradientdivider-success-hover">#ffffff</color>
  <color name="mds-color-theme-gradientdivider-orange-normal">#ffffff</color>
  ...
  <color name="mds-color-theme-avatar-gold">#ffffff</color>
  <color name="mds-color-theme-avatar-lime">#ffffff</color>
  <color name="mds-color-theme-avatar-mint">#ffffff</color>
  <color name="mds-color-theme-avatar-orange">#ffffff</color>
  <color name="mds-color-theme-avatar-pink">#ffffff</color>
  <color name="mds-color-theme-avatar-purple">#ffffff</color>
  ...
  <color name="mds-color-theme-common-button-promotion-normal">#000000</color>
  <color name="mds-color-theme-common-button-promotion-hover">#1aebff</color>
  <color name="mds-color-theme-common-button-promotion-active">#1aebff</color>
  <color name="mds-color-theme-common-button-join-animated-gradient-normal">#1aebff</color>
  ...
  <color name="mds-color-theme-common-background-solid-dark">#000000</color>
  <color name="mds-color-theme-common-background-solid-light">#000000</color>
  ...
  <color name="mds-color-theme-common-touchbar-background-blue-normal">#000000</color>
  <color name="mds-color-theme-common-touchbar-background-blue-pressed">#1aebff</color>
  <color name="mds-color-theme-common-touchbar-background-pink-normal">#000000</color>
  <color name="mds-color-theme-common-touchbar-background-pink-pressed">#1aebff</color>
  <color name="mds-color-theme-common-touchbar-background-mint-normal">#000000</color>
  <color name="mds-color-theme-common-touchbar-background-mint-pressed">#1aebff</color>
  <color name="mds-color-theme-common-touchbar-background-purple-normal">#000000</color>
  <color name="mds-color-theme-common-touchbar-background-purple-pressed">#1aebff</color>
  <color name="mds-color-theme-common-touchbar-background-violet-normal">#000000</color>
  <color name="mds-color-theme-common-touchbar-background-violet-pressed">#1aebff</color>
  <color name="mds-color-theme-common-touchbar-background-orange-normal">#000000</color>
