...
open class LightRoseMomentumThemeTextColorPalette: MomentumThemeTextColorPaletteProtocol {
...
open class LightRoseMomentumThemeInvertedColorPalette: MomentumThemeInvertedColorPaletteProtocol {
...
open class LightRoseMomentumThemeBackgroundColorPalette: MomentumThemeBackgroundColorPaletteProtocol {
    ...
    open var gradientPrimaryNormal0: UIColor { return UIColor(hex: 0xFCEBF5) }
    open var gradientPrimaryNormal1: UIColor { return UIColor(hex: 0xFFFFFF) }
    open var gradientSecondaryNormal0: UIColor { return UIColor(hex: 0xFFF9FD) }
...
open class LightRoseMomentumThemeOutlineColorPalette: MomentumThemeOutlineColorPaletteProtocol {
...
open class LightRoseMomentumThemeOverlayColorPalette: MomentumThemeOverlayColorPaletteProtocol {
...
open class LightRoseMomentumThemeIndicatorColorPalette: MomentumThemeIndicatorColorPaletteProtocol {
...
open class LightRoseMomentumThemeCommonColorPalette: MomentumThemeCommonColorPaletteProtocol {
...
open class LightRoseMomentumThemeScrollbarColorPalette: MomentumThemeScrollbarColorPaletteProtocol {
...
open class LightRoseMomentumThemeIllustrationsColorPalette: MomentumThemeIllustrationsColorPaletteProtocol {
...
open class LightRoseMomentumThemeGlobalTintColorPalette: MomentumThemeGlobalTintColorPaletteProtocol {
    open var normal: UIColor { return UIColor(hex: 0x1170CF) }
    open var selected: UIColor { return UIColor(hex: 0x1170CF) }
    public init() {}
}
open class LightRoseMomentumThemeGroupedBackgroundColorPalette: MomentumThemeGroupedBackgroundColorPaletteProtocol {
...
open class LightRoseMomentumThemeGradientDividerColorPalette: MomentumThemeGradientDividerColorPaletteProtocol {
...
open class LightRoseMomentumThemeFocusColorPalette: MomentumThemeFocusColorPaletteProtocol {
...
open class LightRoseMomentumTheme: MomentumThemeTokensProtocol {
    ...
    public init(
        text: any MomentumThemeTextColorPaletteProtocol = LightRoseMomentumThemeTextColorPalette(),
        inverted: any MomentumThemeInvertedColorPaletteProtocol = LightRoseMomentumThemeInvertedColorPalette(),
        background: any MomentumThemeBackgroundColorPaletteProtocol = LightRoseMomentumThemeBackgroundColorPalette(),
        button: any MomentumThemeButtonColorPaletteProtocol = LightRoseMomentumThemeButtonColorPalette(),
        outline: any MomentumThemeOutlineColorPaletteProtocol = LightRoseMomentumThemeOutlineColorPalette(),
        control: any MomentumThemeControlColorPaletteProtocol = LightRoseMomentumThemeControlColorPalette(),
        overlay: any MomentumThemeOverlayColorPaletteProtocol = LightRoseMomentumThemeOverlayColorPalette(),
        indicator: any MomentumThemeIndicatorColorPaletteProtocol = LightRoseMomentumThemeIndicatorColorPalette(),
        common: any MomentumThemeCommonColorPaletteProtocol = LightRoseMomentumThemeCommonColorPalette(),
        scrollbar: any MomentumThemeScrollbarColorPaletteProtocol = LightRoseMomentumThemeScrollbarColorPalette(),
        illustrations: any MomentumThemeIllustrationsColorPaletteProtocol = LightRoseMomentumThemeIllustrationsColorPalette(),
        globalTint: any MomentumThemeGlobalTintColorPaletteProtocol = LightRoseMomentumThemeGlobalTintColorPalette(),
        groupedBackground: any MomentumThemeGroupedBackgroundColorPaletteProtocol = LightRoseMomentumThemeGroupedBackgroundColorPalette(),
        avatar: any MomentumThemeAvatarColorPaletteProtocol = LightRoseMomentumThemeAvatarColorPalette(),
        gradientDivider: any MomentumThemeGradientDividerColorPaletteProtocol = LightRoseMomentumThemeGradientDividerColorPalette(),
        focus: any MomentumThemeFocusColorPaletteProtocol = LightRoseMomentumThemeFocusColorPalette()
    ) {
        self.text = text
