...
class Searchfield extends ControlTypeMixin(KeyDownHandledMixin(Input)) {
    constructor() {
         ...
         * @internal
         */
        this.chipsWithListeners = new WeakMap();
        /**
         ...
         * @internal
         */
        this.handleChipFocus = (event) => {
            var _a, _b;
            const target = event.currentTarget;
            const chip = this.getChipForFocusTarget(target);
            const index = chip ? ((_b = (_a = this.chips) === null || _a === void 0 ? void 0 : _a.indexOf(chip)) !== null && _b !== void 0 ? _b : -1) : -1;
            if (index >= 0) {
    ...
    handleKeyDown(event) {
        ...
        if (!this.hasChips || !((_a = this.chips) === null || _a === void 0 ? void 0 : _a.length))
            return;
        const input = this.inputElement;
    ...
    disconnectedCallback() {
        ...
        (_a = this.chips) === null || _a === void 0 ? void 0 : _a.forEach(chip => this.removeChipListeners(chip));
    }
    connectedCallback() {
    ...
    renderChips() {
        var _a;
        this.hasChips = !!((_a = this.chips) === null || _a === void 0 ? void 0 : _a.length);
        if (this.chips) {
    ...
    focusChipAtIndex(index) {
        if (!this.chips || index < 0 || index >= this.chips.length)
            return;
        this.focusedChipIndex = index;
        this.resetChipTabIndices();
    ...
    resetChipTabIndices() {
        var _a;
        (_a = this.chips) === null || _a === void 0 ? void 0 : _a.forEach(c => {
     ...
     * @internal
     */
    getFocusTargetForChip(chip) {
        var _a;
        if (chip.matches(INPUT_CHIP_TAG)) {
            const closeBtn = (_a = chip.shadowRoot) === null || _a === void 0 ? void 0 : _a.querySelector('[part="close-icon"]');
            if (closeBtn)
                return closeBtn;
        }
        return chip;
     ...
     * @internal
     */
    getChipForFocusTarget(target) {
        var _a, _b, _c;
        // If the target is a direct chip in the slot, return it
        if ((_a = this.chips) === null || _a === void 0 ? void 0 : _a.includes(target))
            return target;
        // Otherwise, it's the close button inside an inputchip's shadow DOM.
        // Walk up to find the host element.
        const host = (_b = target.getRootNode()) === null || _b === void 0 ? void 0 : _b.host;
        if (host && ((_c = this.chips) === null || _c === void 0 ? void 0 : _c.includes(host)))
            return host;
        return null;
    }
    /**
    ...
    get scrollContainer() {
        var _a, _b;
        return (_b = (_a = this.shadowRoot) === null || _a === void 0 ? void 0 : _a.querySelector('[part="searchfield-container"]')) !== null && _b !== void 0 ? _b : null;
    }
    /**
...
], Searchfield.prototype, "chips", void 0);
__decorate([
    state(),
...
__decorate([
    state(),
    __metadata("design:type", Object)
], Searchfield.prototype, "hasChips", void 0);
