...
type CalendarMonthChangedEvent = TypedCustomEvent<Calendar, {
    month: number;
    year: number;
}>;
interface Events {
...
export type { CalendarDateSelectedEvent, CalendarDayInfo, CalendarGridWeek, CalendarMonthChangedEvent, DateSelectionDetail, Events, SelectionMode, };
