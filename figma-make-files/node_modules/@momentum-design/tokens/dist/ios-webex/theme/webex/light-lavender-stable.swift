...
open class LightLavenderMomentumThemeTextColorPalette: MomentumThemeTextColorPaletteProtocol {
...
open class LightLavenderMomentumThemeInvertedColorPalette: MomentumThemeInvertedColorPaletteProtocol {
...
open class LightLavenderMomentumThemeBackgroundColorPalette: MomentumThemeBackgroundColorPaletteProtocol {
    ...
    open var gradientPrimaryNormal0: UIColor { return UIColor(hex: 0xF4EBFF) }
    open var gradientPrimaryNormal1: UIColor { return UIColor(hex: 0xFFFFFF) }
    open var gradientSecondaryNormal0: UIColor { return UIColor(hex: 0xFBF7FF) }
...
open class LightLavenderMomentumThemeOutlineColorPalette: MomentumThemeOutlineColorPaletteProtocol {
    ...
    open var labelCobalt: UIColor { return UIColor(hex: 0x0A78CC) }
    open var labelGold: UIColor { return UIColor(hex: 0x996E00) }
    open var labelLime: UIColor { return UIColor(hex: 0x588219) }
    open var labelMint: UIColor { return UIColor(hex: 0x148579) }
    open var labelOrange: UIColor { return UIColor(hex: 0xC94403) }
    open var labelPink: UIColor { return UIColor(hex: 0xD43B52) }
    open var labelPurple: UIColor { return UIColor(hex: 0xC233C4) }
    open var labelSlate: UIColor { return UIColor(hex: 0x6F739E) }
    open var labelViolet: UIColor { return UIColor(hex: 0x875AE0) }
...
open class LightLavenderMomentumThemeOverlayColorPalette: MomentumThemeOverlayColorPaletteProtocol {
...
open class LightLavenderMomentumThemeIndicatorColorPalette: MomentumThemeIndicatorColorPaletteProtocol {
...
open class LightLavenderMomentumThemeCommonColorPalette: MomentumThemeCommonColorPaletteProtocol {
    ...
    open var contentSheets: UIColor { return UIColor(hex: 0x0F9D58) }
    open var contentSlides: UIColor { return UIColor(hex: 0xF4B400) }
...
open class LightLavenderMomentumThemeScrollbarColorPalette: MomentumThemeScrollbarColorPaletteProtocol {
...
open class LightLavenderMomentumThemeIllustrationsColorPalette: MomentumThemeIllustrationsColorPaletteProtocol {
...
open class LightLavenderMomentumThemeGlobalTintColorPalette: MomentumThemeGlobalTintColorPaletteProtocol {
    open var normal: UIColor { return UIColor(hex: 0x1170CF) }
    open var selected: UIColor { return UIColor(hex: 0x1170CF) }
    public init() {}
}
open class LightLavenderMomentumThemeGroupedBackgroundColorPalette: MomentumThemeGroupedBackgroundColorPaletteProtocol {
...
open class LightLavenderMomentumThemeGradientDividerColorPalette: MomentumThemeGradientDividerColorPaletteProtocol {
...
open class LightLavenderMomentumThemeFocusColorPalette: MomentumThemeFocusColorPaletteProtocol {
...
open class LightLavenderMomentumTheme: MomentumThemeTokensProtocol {
    ...
    public init(
        text: any MomentumThemeTextColorPaletteProtocol = LightLavenderMomentumThemeTextColorPalette(),
        inverted: any MomentumThemeInvertedColorPaletteProtocol = LightLavenderMomentumThemeInvertedColorPalette(),
        background: any MomentumThemeBackgroundColorPaletteProtocol = LightLavenderMomentumThemeBackgroundColorPalette(),
        button: any MomentumThemeButtonColorPaletteProtocol = LightLavenderMomentumThemeButtonColorPalette(),
        outline: any MomentumThemeOutlineColorPaletteProtocol = LightLavenderMomentumThemeOutlineColorPalette(),
        control: any MomentumThemeControlColorPaletteProtocol = LightLavenderMomentumThemeControlColorPalette(),
        overlay: any MomentumThemeOverlayColorPaletteProtocol = LightLavenderMomentumThemeOverlayColorPalette(),
        indicator: any MomentumThemeIndicatorColorPaletteProtocol = LightLavenderMomentumThemeIndicatorColorPalette(),
        common: any MomentumThemeCommonColorPaletteProtocol = LightLavenderMomentumThemeCommonColorPalette(),
        scrollbar: any MomentumThemeScrollbarColorPaletteProtocol = LightLavenderMomentumThemeScrollbarColorPalette(),
        illustrations: any MomentumThemeIllustrationsColorPaletteProtocol = LightLavenderMomentumThemeIllustrationsColorPalette(),
        globalTint: any MomentumThemeGlobalTintColorPaletteProtocol = LightLavenderMomentumThemeGlobalTintColorPalette(),
        groupedBackground: any MomentumThemeGroupedBackgroundColorPaletteProtocol = LightLavenderMomentumThemeGroupedBackgroundColorPalette(),
        avatar: any MomentumThemeAvatarColorPaletteProtocol = LightLavenderMomentumThemeAvatarColorPalette(),
        gradientDivider: any MomentumThemeGradientDividerColorPaletteProtocol = LightLavenderMomentumThemeGradientDividerColorPalette(),
        focus: any MomentumThemeFocusColorPaletteProtocol = LightLavenderMomentumThemeFocusColorPalette()
    ) {
        self.text = text
