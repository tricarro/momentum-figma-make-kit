...
open class LightBronzeMomentumThemeTextColorPalette: MomentumThemeTextColorPaletteProtocol {
...
open class LightBronzeMomentumThemeInvertedColorPalette: MomentumThemeInvertedColorPaletteProtocol {
...
open class LightBronzeMomentumThemeBackgroundColorPalette: MomentumThemeBackgroundColorPaletteProtocol {
    ...
    open var gradientPrimaryNormal0: UIColor { return UIColor(hex: 0xF5EFE4) }
    open var gradientPrimaryNormal1: UIColor { return UIColor(hex: 0xFFFFFF) }
    open var gradientSecondaryNormal0: UIColor { return UIColor(hex: 0xFCFAF4) }
...
open class LightBronzeMomentumThemeOutlineColorPalette: MomentumThemeOutlineColorPaletteProtocol {
...
open class LightBronzeMomentumThemeOverlayColorPalette: MomentumThemeOverlayColorPaletteProtocol {
...
open class LightBronzeMomentumThemeIndicatorColorPalette: MomentumThemeIndicatorColorPaletteProtocol {
...
open class LightBronzeMomentumThemeCommonColorPalette: MomentumThemeCommonColorPaletteProtocol {
...
open class LightBronzeMomentumThemeScrollbarColorPalette: MomentumThemeScrollbarColorPaletteProtocol {
...
open class LightBronzeMomentumThemeIllustrationsColorPalette: MomentumThemeIllustrationsColorPaletteProtocol {
...
open class LightBronzeMomentumThemeGlobalTintColorPalette: MomentumThemeGlobalTintColorPaletteProtocol {
    open var normal: UIColor { return UIColor(hex: 0x1170CF) }
    open var selected: UIColor { return UIColor(hex: 0x1170CF) }
    public init() {}
}
open class LightBronzeMomentumThemeGroupedBackgroundColorPalette: MomentumThemeGroupedBackgroundColorPaletteProtocol {
...
open class LightBronzeMomentumThemeGradientDividerColorPalette: MomentumThemeGradientDividerColorPaletteProtocol {
...
open class LightBronzeMomentumThemeFocusColorPalette: MomentumThemeFocusColorPaletteProtocol {
...
open class LightBronzeMomentumTheme: MomentumThemeTokensProtocol {
    ...
    public init(
        text: any MomentumThemeTextColorPaletteProtocol = LightBronzeMomentumThemeTextColorPalette(),
        inverted: any MomentumThemeInvertedColorPaletteProtocol = LightBronzeMomentumThemeInvertedColorPalette(),
        background: any MomentumThemeBackgroundColorPaletteProtocol = LightBronzeMomentumThemeBackgroundColorPalette(),
        button: any MomentumThemeButtonColorPaletteProtocol = LightBronzeMomentumThemeButtonColorPalette(),
        outline: any MomentumThemeOutlineColorPaletteProtocol = LightBronzeMomentumThemeOutlineColorPalette(),
        control: any MomentumThemeControlColorPaletteProtocol = LightBronzeMomentumThemeControlColorPalette(),
        overlay: any MomentumThemeOverlayColorPaletteProtocol = LightBronzeMomentumThemeOverlayColorPalette(),
        indicator: any MomentumThemeIndicatorColorPaletteProtocol = LightBronzeMomentumThemeIndicatorColorPalette(),
        common: any MomentumThemeCommonColorPaletteProtocol = LightBronzeMomentumThemeCommonColorPalette(),
        scrollbar: any MomentumThemeScrollbarColorPaletteProtocol = LightBronzeMomentumThemeScrollbarColorPalette(),
        illustrations: any MomentumThemeIllustrationsColorPaletteProtocol = LightBronzeMomentumThemeIllustrationsColorPalette(),
        globalTint: any MomentumThemeGlobalTintColorPaletteProtocol = LightBronzeMomentumThemeGlobalTintColorPalette(),
        groupedBackground: any MomentumThemeGroupedBackgroundColorPaletteProtocol = LightBronzeMomentumThemeGroupedBackgroundColorPalette(),
        avatar: any MomentumThemeAvatarColorPaletteProtocol = LightBronzeMomentumThemeAvatarColorPalette(),
        gradientDivider: any MomentumThemeGradientDividerColorPaletteProtocol = LightBronzeMomentumThemeGradientDividerColorPalette(),
        focus: any MomentumThemeFocusColorPaletteProtocol = LightBronzeMomentumThemeFocusColorPalette()
    ) {
        self.text = text
