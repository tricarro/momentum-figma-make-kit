...
<resources>
  ...
  <color name="mds-color-theme-background-gradient-primary-normal">linear-gradient(180deg, #f5efe4 0%, #ffffff 100%)</color>
  <color name="mds-color-theme-background-gradient-secondary-normal">linear-gradient(180deg, #fcfaf4 0%, #ffffff 100%)</color>
