...
class SpatialNavigationProvider extends Provider {
    ...
    constructor() {
         ...
         * - escape: "Escape"
         */
        this.navigationKeyMapping = DEFAULTS.SPATIAL_NAVIGATION_KEY_MAPPING;
        /**
         * Weights used in the distance calculation algorithm
         * @see https://www.w3.org/TR/css-nav-1/#find-the-shortest-distance
         */
        this.distanceCalculationWeights = DEFAULTS.WEIGHTS;
        /**
         * Root element
         * @internal
         */
        ...
        this.handleKeyDown = (evt) => {
            ...
            if (evt.target) {
                (_a = (evt.composedPath()[0] || evt.target)) === null || _a === void 0 ? void 0 : _a.dispatchEvent(navBeforeProcessEvent);
            }
         ...
         * @internal
         */
        this.activeElementObserverCallback = () => {
            ...
            if (!currentActiveElement || !currentActiveElement.isConnected) {
                ...
                if (this.root.contains(document.activeElement)) {
                    const activeDomElement = getDomActiveElement();
                    if (activeDomElement) {
    ...
    updateContext() {
        ...
        if (!actionToKeyMap ||
            ...
            this.context.value = {
                ...
                keyToActionMap: Object.fromEntries(Object.entries(this.navigationKeyMapping).map(([action, key]) => [key, action])),
            };
     ...
     * @internal
     */
    initActiveElement(nextActiveElement) {
     ...
     * @internal
     */
    findActiveElement(elements, currentActiveElement) {
     ...
     * @internal
     */
    emitNavBeforeFocusEvent(focusCandidate, direction) {
        var _a;
        if (focusCandidate) {
            const focusEvent = new SpatialNavigationEvent('navbeforefocus', focusCandidate, direction);
            (_a = this.getActiveElement()) === null || _a === void 0 ? void 0 : _a.dispatchEvent(focusEvent);
    ...
    focusNextInFocusableAria(elements, direction) {
        ...
        if (currentDomActiveElement) {
            const elementWithDataset = getHostComposePath(currentDomActiveElement).find(node => node.hasAttribute(dataAttrName));
            const nextElementId = elementWithDataset === null || elementWithDataset === void 0 ? void 0 : elementWithDataset.getAttribute(dataAttrName);
            if (elementWithDataset && nextElementId) {
                const nextElement = (_a = elementWithDataset.getRootNode()) === null || _a === void 0 ? void 0 : _a.getElementById(nextElementId);
                if (nextElement) {
                    return nextElement;
                }
            }
     ...
     * @internal
     */
    emitGoBackEvent(goBackElement) {
        const goBackEvent = new SpatialNavigationEvent('navback', goBackElement, 'escape');
     ...
     * @internal
     */
    setActiveElementAndFocus(element) {
...
], SpatialNavigationProvider.prototype, "navigationKeyMapping", void 0);
__decorate([
    property({ attribute: false }),
    __metadata("design:type", Object)
], SpatialNavigationProvider.prototype, "distanceCalculationWeights", void 0);
