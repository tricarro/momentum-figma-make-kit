...
open class LightJadeMomentumThemeTextColorPalette: MomentumThemeTextColorPaletteProtocol {
...
open class LightJadeMomentumThemeInvertedColorPalette: MomentumThemeInvertedColorPaletteProtocol {
...
open class LightJadeMomentumThemeBackgroundColorPalette: MomentumThemeBackgroundColorPaletteProtocol {
    ...
    open var gradientPrimaryNormal0: UIColor { return UIColor(hex: 0xE6F2F1) }
    open var gradientPrimaryNormal1: UIColor { return UIColor(hex: 0xFFFFFF) }
    open var gradientSecondaryNormal0: UIColor { return UIColor(hex: 0xF7FCFC) }
...
open class LightJadeMomentumThemeOutlineColorPalette: MomentumThemeOutlineColorPaletteProtocol {
...
open class LightJadeMomentumThemeOverlayColorPalette: MomentumThemeOverlayColorPaletteProtocol {
...
open class LightJadeMomentumThemeIndicatorColorPalette: MomentumThemeIndicatorColorPaletteProtocol {
...
open class LightJadeMomentumThemeCommonColorPalette: MomentumThemeCommonColorPaletteProtocol {
...
open class LightJadeMomentumThemeScrollbarColorPalette: MomentumThemeScrollbarColorPaletteProtocol {
...
open class LightJadeMomentumThemeIllustrationsColorPalette: MomentumThemeIllustrationsColorPaletteProtocol {
...
open class LightJadeMomentumThemeGlobalTintColorPalette: MomentumThemeGlobalTintColorPaletteProtocol {
    open var normal: UIColor { return UIColor(hex: 0x1170CF) }
    open var selected: UIColor { return UIColor(hex: 0x1170CF) }
    public init() {}
}
open class LightJadeMomentumThemeGroupedBackgroundColorPalette: MomentumThemeGroupedBackgroundColorPaletteProtocol {
...
open class LightJadeMomentumThemeGradientDividerColorPalette: MomentumThemeGradientDividerColorPaletteProtocol {
...
open class LightJadeMomentumThemeFocusColorPalette: MomentumThemeFocusColorPaletteProtocol {
...
open class LightJadeMomentumTheme: MomentumThemeTokensProtocol {
    ...
    public init(
        text: any MomentumThemeTextColorPaletteProtocol = LightJadeMomentumThemeTextColorPalette(),
        inverted: any MomentumThemeInvertedColorPaletteProtocol = LightJadeMomentumThemeInvertedColorPalette(),
        background: any MomentumThemeBackgroundColorPaletteProtocol = LightJadeMomentumThemeBackgroundColorPalette(),
        button: any MomentumThemeButtonColorPaletteProtocol = LightJadeMomentumThemeButtonColorPalette(),
        outline: any MomentumThemeOutlineColorPaletteProtocol = LightJadeMomentumThemeOutlineColorPalette(),
        control: any MomentumThemeControlColorPaletteProtocol = LightJadeMomentumThemeControlColorPalette(),
        overlay: any MomentumThemeOverlayColorPaletteProtocol = LightJadeMomentumThemeOverlayColorPalette(),
        indicator: any MomentumThemeIndicatorColorPaletteProtocol = LightJadeMomentumThemeIndicatorColorPalette(),
        common: any MomentumThemeCommonColorPaletteProtocol = LightJadeMomentumThemeCommonColorPalette(),
        scrollbar: any MomentumThemeScrollbarColorPaletteProtocol = LightJadeMomentumThemeScrollbarColorPalette(),
        illustrations: any MomentumThemeIllustrationsColorPaletteProtocol = LightJadeMomentumThemeIllustrationsColorPalette(),
        globalTint: any MomentumThemeGlobalTintColorPaletteProtocol = LightJadeMomentumThemeGlobalTintColorPalette(),
        groupedBackground: any MomentumThemeGroupedBackgroundColorPaletteProtocol = LightJadeMomentumThemeGroupedBackgroundColorPalette(),
        avatar: any MomentumThemeAvatarColorPaletteProtocol = LightJadeMomentumThemeAvatarColorPalette(),
        gradientDivider: any MomentumThemeGradientDividerColorPaletteProtocol = LightJadeMomentumThemeGradientDividerColorPalette(),
        focus: any MomentumThemeFocusColorPaletteProtocol = LightJadeMomentumThemeFocusColorPalette()
    ) {
        self.text = text
