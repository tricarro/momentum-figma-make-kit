...
<resources>
  ...
  <color name="mds-color-theme-text-success-normal">#185e46</color>
  <color name="mds-color-theme-text-success-hover">#0e2b20</color>
  <color name="mds-color-theme-text-success-active">#0e2b20</color>
  <color name="mds-color-theme-text-warning-normal">#7d4705</color>
  <color name="mds-color-theme-text-warning-hover">#36220c</color>
  <color name="mds-color-theme-text-warning-active">#36220c</color>
  <color name="mds-color-theme-text-highlight">#bfe3ff</color>
  <color name="mds-color-theme-text-accent-normal">#0353a8</color>
  <color name="mds-color-theme-text-accent-hover">#0a274a</color>
  <color name="mds-color-theme-text-accent-active">#0a274a</color>
  <color name="mds-color-theme-text-teamdefault-normal">#000000b3</color>
  <color name="mds-color-theme-text-teamdefault-hover">#000000b3</color>
  <color name="mds-color-theme-text-teamdefault-active">#000000f2</color>
  ...
  <color name="mds-color-theme-text-team-cyan-normal">#066070</color>
  <color name="mds-color-theme-text-team-cyan-hover">#0b2a30</color>
  <color name="mds-color-theme-text-team-cyan-active">#0b2a30</color>
  <color name="mds-color-theme-text-team-mint-normal">#12615a</color>
  <color name="mds-color-theme-text-team-mint-hover">#102b2a</color>
  <color name="mds-color-theme-text-team-mint-active">#102b2a</color>
  <color name="mds-color-theme-text-team-lime-normal">#416116</color>
  <color name="mds-color-theme-text-team-lime-hover">#416116</color>
  <color name="mds-color-theme-text-team-lime-active">#1e2b10</color>
  ...
  <color name="mds-color-theme-text-team-purple-normal">#932099</color>
  <color name="mds-color-theme-text-team-purple-hover">#932099</color>
  <color name="mds-color-theme-text-team-purple-active">#3b1840</color>
  <color name="mds-color-theme-text-team-violet-normal">#643abd</color>
  <color name="mds-color-theme-text-team-violet-hover">#643abd</color>
  <color name="mds-color-theme-text-team-violet-active">#29223d</color>
  ...
  <color name="mds-color-theme-inverted-text-accent-active">#bfe3ff</color>
  ...
  <color name="mds-color-theme-background-secondary-normal">#0000001c</color>
  ...
  <color name="mds-color-theme-background-alert-default-hover">#dedede</color>
  <color name="mds-color-theme-background-alert-default-active">#c9c9c9</color>
  <color name="mds-color-theme-background-alert-success-normal">#cef5eb</color>
  <color name="mds-color-theme-background-alert-success-hover">#cef5eb</color>
  <color name="mds-color-theme-background-alert-success-active">#9fedd8</color>
  <color name="mds-color-theme-background-alert-warning-normal">#ffebc2</color>
  <color name="mds-color-theme-background-alert-warning-hover">#ffebc2</color>
  <color name="mds-color-theme-background-alert-warning-active">#ffda94</color>
  <color name="mds-color-theme-background-alert-error-normal">#ffe8ea</color>
  <color name="mds-color-theme-background-alert-error-hover">#ffe8ea</color>
  <color name="mds-color-theme-background-alert-error-active">#ffd4da</color>
  <color name="mds-color-theme-background-alert-theme-normal">#dbf0ff</color>
  <color name="mds-color-theme-background-alert-theme-hover">#dbf0ff</color>
  <color name="mds-color-theme-background-alert-theme-active">#bfe3ff</color>
  <color name="mds-color-theme-background-alert-purple-normal">#fcf2fc</color>
  <color name="mds-color-theme-background-alert-purple-hover">#fcf2fc</color>
  ...
  <color name="mds-color-theme-background-label-gold-normal">#f7f6dc</color>
  <color name="mds-color-theme-background-label-gold-hover">#f5eaa2</color>
  <color name="mds-color-theme-background-label-gold-active">#ebd460</color>
  <color name="mds-color-theme-background-label-lime-normal">#f3f7e9</color>
  <color name="mds-color-theme-background-label-lime-hover">#ddf2ae</color>
  <color name="mds-color-theme-background-label-lime-active">#bce36f</color>
  <color name="mds-color-theme-background-label-mint-normal">#e9f7f3</color>
  ...
  <color name="mds-color-theme-background-label-purple-normal">#fcf2fc</color>
  <color name="mds-color-theme-background-label-purple-hover">#fce1fc</color>
  <color name="mds-color-theme-background-label-purple-active">#fac3f8</color>
  <color name="mds-color-theme-background-label-slate-normal">#f2f4ff</color>
  <color name="mds-color-theme-background-label-slate-hover">#e3e7fa</color>
  <color name="mds-color-theme-background-label-slate-active">#ced2ed</color>
  <color name="mds-color-theme-background-label-violet-normal">#f8f2fc</color>
  ...
  <color name="mds-color-theme-background-label-default-normal">#ededed</color>
  <color name="mds-color-theme-background-label-default-hover">#dedede</color>
  <color name="mds-color-theme-background-label-default-active">#c9c9c9</color>
  <color name="mds-color-theme-background-label-error-normal">#ffe8ea</color>
  <color name="mds-color-theme-background-label-error-hover">#ffd4da</color>
  <color name="mds-color-theme-background-label-error-active">#ffb8c1</color>
  <color name="mds-color-theme-background-namelabel-normal">#000000b3</color>
  <color name="mds-color-theme-background-gradient-primary-normal">linear-gradient(180deg, #ebeffc 0%, #ffffff 100%)</color>
  <color name="mds-color-theme-background-gradient-secondary-normal">linear-gradient(180deg, #f7f9ff 0%, #ffffff 100%)</color>
  ...
  <color name="mds-color-theme-background-glass-active">#ffffff99</color>
  ...
  <color name="mds-color-theme-background-glass-radial-0">#ffffff0d</color>
  <color name="mds-color-theme-background-glass-radial-1">#ffffff00</color>
  <color name="mds-color-theme-background-input-disabled">#0000001c</color>
  <color name="mds-color-theme-background-overlay-normal">#07101c66</color>
  ...
  <color name="mds-color-theme-button-secondary-disabled">#00000000</color>
  <color name="mds-color-theme-button-secondary-active-normal">#00000033</color>
  <color name="mds-color-theme-button-secondary-active-hover">#0000004d</color>
  <color name="mds-color-theme-button-secondary-active-pressed">#00000066</color>
  <color name="mds-color-theme-button-secondary-active-disabled">#0000001c</color>
  ...
  <color name="mds-color-theme-outline-label-cobalt">#0a78cc</color>
  <color name="mds-color-theme-outline-label-gold">#996e00</color>
  <color name="mds-color-theme-outline-label-lime">#588219</color>
  <color name="mds-color-theme-outline-label-mint">#148579</color>
  <color name="mds-color-theme-outline-label-orange">#c94403</color>
  <color name="mds-color-theme-outline-label-pink">#d43b52</color>
  <color name="mds-color-theme-outline-label-purple">#c233c4</color>
  <color name="mds-color-theme-outline-label-slate">#6f739e</color>
  <color name="mds-color-theme-outline-label-violet">#875ae0</color>
  ...
  <color name="mds-color-theme-outline-glass-normal">linear-gradient(180deg, #00000012 0%, #00000033 100%)</color>
  ...
  <color name="mds-color-theme-control-inactive-normal">#0000001c</color>
  <color name="mds-color-theme-control-inactive-hover">#00000033</color>
  <color name="mds-color-theme-control-inactive-pressed">#0000004d</color>
  <color name="mds-color-theme-control-inactive-disabled">#00000012</color>
  ...
  <color name="mds-color-theme-indicator-caution">#a65e00</color>
  <color name="mds-color-theme-indicator-secure">#1170cf</color>
  ...
  <color name="mds-color-theme-common-outline-button-normal">#ffffff80</color>
  ...
  <color name="mds-color-theme-illustrations-default">#000000</color>
  <color name="mds-color-theme-globaltint-normal">#1170cf</color>
  <color name="mds-color-theme-globaltint-selected">#1170cf</color>
  <color name="mds-color-theme-groupedbackground-primary-normal">#f7f7f7</color>
  ...
  <color name="mds-color-theme-gradientdivider-warning-normal">linear-gradient(90deg, #7d470500 0%, #7d470599 22.4%, #7d470599 76.04%, #7d470500 100%)</color>
  <color name="mds-color-theme-gradientdivider-warning-hover">linear-gradient(90deg, #7d470500 0%, #7d4705e6 22.4%, #7d4705e6 76.04%, #7d470500 100%)</color>
  <color name="mds-color-theme-gradientdivider-announce-normal">linear-gradient(90deg, #0353a800 0%, #0353a899 22.4%, #0353a899 22.4%, #0353a800 100%)</color>
  <color name="mds-color-theme-gradientdivider-announce-hover">linear-gradient(90deg, #0353a800 0%, #0353a8E6 76.04%, #0353a8E6 76.04%, #0353a800 100%)</color>
  <color name="mds-color-theme-gradientdivider-success-normal">linear-gradient(90deg, #185e4600 0%, #185e4699 22.4%, #185e4699 76.04%, #185e4600 100%)</color>
  <color name="mds-color-theme-gradientdivider-success-hover">linear-gradient(90deg, #185e4600 0%, #185e46E6 22.4%, #185e46E6 76.04%, #185e4600 100%)</color>
  <color name="mds-color-theme-gradientdivider-orange-normal">linear-gradient(90deg, #9c320200 0%, #9c320299 22.4%, #9c320299 76.04%, #9c320200 100%)</color>
