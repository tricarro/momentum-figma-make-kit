...
**Cursor / IDE:** Translated Cursor rules (`.mdc`) mirroring this folder live at **[`../../cursor/rules/`](../../cursor/rules/README.md)** — regenerate with `node cursor/rules/scripts/build-guidance.mjs` from the repo root after guideline edits.
